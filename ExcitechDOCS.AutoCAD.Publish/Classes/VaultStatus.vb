...
Public Class VaultStatus
    ...
    Public Shared VaultConnectionString As String
    ...
    Shared ReadOnly Property Status() As VaultStatuses
        Get
            ...
            Try
                vaultConnection = g_clientApplication.GetVaultConnection(VaultConnectionString)
    ...
    Public Shared Function initialiseMFiles(Optional ForceReconnection As Boolean = False) As Vault
        ...
        Try
            ...
            If VaultConnectionString = "" Then vault = Nothing : Return Nothing
            'try getting a Vault object
            Dim vaultConnection = g_clientApplication.GetVaultConnection(VaultConnectionString)
    ...
    Public Shared Function CreateVaultObject() As Vault
        Try
            Dim clientApp As New MFilesClientApplication
            Dim vaultCN = clientApp.GetVaultConnection(VaultConnectionString)
            Return vaultCN.BindToVault(0, False, True)
        Catch ex As Exception
